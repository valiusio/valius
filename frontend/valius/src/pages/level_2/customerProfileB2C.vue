            ...
            <div class="customer-profile__forms">
                    ...
                    <div class="customer-profile__form-container">
                        ...
                        <md-field>
                            ...
                            <md-select name="productUsage" v-validate="''" v-model="customers.customer1.productUsage">
                                <md-optgroup>
                        ...
                        <md-field>
                            ...
                            <md-select name="brandFidelity" v-validate="''" v-model="customers.customer1.brandFidelity">
                                <md-optgroup>
                        ...
                        <md-field>
                            ...
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer1.communicationMeans" multiple >
                        ...
                        <md-field>
                            ...
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer1.lifeStyle" multiple >
                    ...
                    <div class="customer-profile__form-container">
                        ...
                        <md-field>
                            <label>Βαθμός χρήσης προϊόντος μας</label>
                            <md-select name="productUsage" v-validate="''" v-model="customers.customer2.productUsage">
                                <md-optgroup>
                                    <md-option value="Υψηλή χρήση" >Υψηλή χρήση</md-option>
                                    <md-option value="Τακτική χρήση" >Τακτική χρήση</md-option>
                                    <md-option value="Πρώτη φορά" >Πρώτη φορά</md-option>
                        ...
                        <md-field>
                            <label>Πιστότητα στη μάρκα</label>
                            <md-select name="brandFidelity" v-validate="''" v-model="customers.customer2.brandFidelity">
                                <md-optgroup>
                                    <md-option value="Πιστοί/ Ικανοποιημένοι" >Πιστοί/ Ικανοποιημένοι</md-option>
                                    <md-option value="Πρώιμοι πελάτες" >Πρώιμοι πελάτες</md-option>
                                    <md-option value="Ευκαιριακοί" >Ευκαιριακοί</md-option>
                        ...
                        <md-field>
                            <label>Mέσα επικοινωνίας</label>
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer2.communicationMeans" multiple >
                                    <md-option value="TV" >TV</md-option>
                                    <md-option value="Ραδιόφωνο" >Ραδιόφωνο</md-option>
                                    <md-option value="Διαφήμιση Online" >Διαφήμιση Online</md-option>
                                    <md-option value="Social media">Social media</md-option>
                        ...
                        <md-field>
                            <label>Τρόπος ζωής</label>
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer2.lifeStyle" multiple >
                                <md-option value="Αθλητικοί" >Αθλητικοί</md-option>
                                <md-option value="Αισθητικοί" >Αισθητικοί</md-option>
                                <md-option value="Αισιόδοξοι" >Αισιόδοξοι</md-option>
                                <md-option value="Αλαζονικοί" >Αλαζονικοί</md-option>
                    ...
                    <div class="customer-profile__form-container">
                        ...
                        <md-field>
                            <label>Βαθμός χρήσης προϊόντος μας</label>
                            <md-select name="productUsage" v-validate="''" v-model="customers.customer3.productUsage">
                                <md-optgroup>
                                    <md-option value="Υψηλή χρήση" >Υψηλή χρήση</md-option>
                                    <md-option value="Τακτική χρήση" >Τακτική χρήση</md-option>
                                    <md-option value="Πρώτη φορά" >Πρώτη φορά</md-option>
                        ...
                        <md-field>
                            <label>Πιστότητα στη μάρκα</label>
                            <md-select name="brandFidelity" v-validate="''" v-model="customers.customer3.brandFidelity">
                                <md-optgroup>
                                    <md-option value="Πιστοί/ Ικανοποιημένοι" >Πιστοί/ Ικανοποιημένοι</md-option>
                                    <md-option value="Πρώιμοι πελάτες" >Πρώιμοι πελάτες</md-option>
                                    <md-option value="Ευκαιριακοί" >Ευκαιριακοί</md-option>
                        ...
                        <md-field>
                            <label>Mέσα επικοινωνίας</label>
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer3.communicationMeans" multiple >
                                    <md-option value="TV" >TV</md-option>
                                    <md-option value="Ραδιόφωνο" >Ραδιόφωνο</md-option>
                                    <md-option value="Διαφήμιση Online" >Διαφήμιση Online</md-option>
                                    <md-option value="Social media">Social media</md-option>
                        ...
                        <md-field>
                            <label>Τρόπος ζωής</label>
                            <md-select name="communicationMeans" v-validate="''" v-model="customers.customer3.lifeStyle" multiple >
                                <md-option value="Αθλητικοί" >Αθλητικοί</md-option>
                                <md-option value="Αισθητικοί" >Αισθητικοί</md-option>
                                <md-option value="Αισιόδοξοι" >Αισιόδοξοι</md-option>
                                <md-option value="Αλαζονικοί" >Αλαζονικοί</md-option>
