<template>
    ...
    <div class="pyramid-game container container--exlg">
        ...
        <information-banner
            type="danger"
        >
            <h1>Είναι η ώρα για την πυραμίδα αξίας του προϊόντος σου!</h1>

            <p>Επέλεξε από την στήλη δεξιά τα αγοραστικά κριτήρια του προιόντος σου,
                ξεκινώντας από τα λιγότερα μέχρι τα περισσότερο σημαντικά.
            </p>
        </information-banner>
